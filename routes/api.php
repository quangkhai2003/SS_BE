...
//    Route::get('/checkIn7Day', [AuthController::class, 'checkIn7Day'])->middleware('checkrole:User|Guest');
    ...
    Route::post('/addWordToYourDictionary', [DictionaryController::class, 'addWordToYourDictionary'])->middleware('checkrole:User|Guest');
    Route::get('/getYourDictionary', [DictionaryController::class, 'getYourDictionary'])->middleware('checkrole:User|Guest');
